...
with open("/Users/sunyiyao/Desktop/T2W路径/NSCLC.json", 'r') as load_f:
...
for pathdicom in pathlist:
  ...
  for listnum in listpic:
    if 'T2W_nii' in listnum and 'nrrd' in listnum:
      path_nii_nrrd = os.path.join(pathdicom, listnum)
      maskName = path_nii_nrrd
      break
  for listnum in listpic:
    if 'T2W_dcm' in listnum and 'nrrd' in listnum:
  ...
  path_fea_all = r'/Users/sunyiyao/Desktop/NSCLC_T2W_TAA.xlsx'
